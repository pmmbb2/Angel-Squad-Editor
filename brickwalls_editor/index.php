...
<div id="BW-ed-tabs">
  <ul>
	...
	<li><a href="#BW-ed-tabs-3">brickwall</a></li>    
    <li><a href="#BW-ed-tabs-4">brickwalls</a></li>    
  </ul>
	 ...
	 <?php require('../searchForm.php');?>
	  ...
	  <div id="BW-ed-tabs-4">
		...
		<div class='submit_reset'>
			<input type='submit' id='save_brickwall' value='save brickwall' />
			<input type='button' id='reset_brickwall_ed_frm' value='reset form' />
		</div>
  	</form>
</div>
